        ...
        <div class="card border-top  border-primary">
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Edit Subategory</h5>
                </div>
                <hr>
                <form class="row g-3" method="POST" action="{{route('subcategories.update',$subcategory->id)}}">
                    @csrf
                     @method('PUT')
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="description" class="form-control" id="desc" value="{{$subcategory->description}}">
                        @error('Description')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="image" name="image" value="{{$subcategory->image}}">
                        @error('image')
                        <p style="color: #f00">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="active" value="1" {{
                                old('is_active', $subcategory->is_active ?? 1) == 1 ? 'checked' : '' }}>
                            <label class="form-check-label" for="active">Active</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="inactive" value="0" {{
                                old('is_active', $subcategory->is_active ?? 1) == 0 ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="inputAddress2" name="meta_description"
                            rows="3">{{$subcategory->meta_description}}</textarea>
                    </div>
                    <div class="col-12">
