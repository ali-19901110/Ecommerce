        ...
        <form class="row g-3" id="create-category-form">
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="is_active" id="checkCreateactive" value="1" {{
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="is_active" id="checkCreateinactive" value="0" {{
          ...
          <div class="col-12">
            ...
            <input type="text" name="meta_title" class="form-control" id="inputCreateAddress"
